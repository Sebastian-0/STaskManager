...
public class PerformancePanel extends JPanel
{
  ...
  public PerformancePanel(Process process) {
    ...
    cpuGraph.addGraph(new DoubleToLong(process.cpuUsage));
    ...
    cpuTimeline.addGraph(new DoubleToLong(process.cpuUsage));
  ...
  public void update() {
    ...
    labelCpuCurrent.setText(String.format("%.1f%%", 100*process.cpuUsage.newest()));
