...
public class DiskPanel extends JPanel
{
  ...
  private JLabel labelTransferMax;
  
  private GraphPanel activeTimeGraph;
  private GraphPanel transferGraph;
  private TimelineGraphPanel timelineGraph;
  
  private InformationItemPanel activeTimePanel;
  private InformationItemPanel ioQueueLengthPanel;
  private InformationItemPanel writeTransferPanel;
  private InformationItemPanel readTransferPanel;
  ...
  public DiskPanel(TimelineGroup timelineGroup, Disk disk) {
    ...
    activeTimeGraph = new GraphPanel(GraphType.Disk, true);
    transferGraph = new GraphPanel(GraphType.Disk, true);
...
//    layout.addToGrid(labelMaxTime       , 0, 6, 2, 1, GridBagConstraints.WEST);
  ...
  public GraphTypeButton createNetworkButton(int index) {
    connectedButton = new GraphTypeButton(GraphType.Disk, String.format("Disk %d (%s)", disk.index, disk.name), index);
